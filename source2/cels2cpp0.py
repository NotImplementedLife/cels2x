...
class CelsEnv2Cpp:
    ...
    def compile_env(self)->CppSnippet:
        ...
        decls = self.__build_forward_declarations(global_decls)        
        
        
        return CppSnippet([decls, "\n\n", snippets_stack[0]])
        
    def __build_forward_declarations(self, decls:list)->CppSnippet:
        snippet = CppSnippet(["// forward declarations\n"])
        
        structs = {}
        funcs = {}
        
        for decl in decls:            
            snippet += f"// TO DO: {decl} ({type(decl)})\n"
