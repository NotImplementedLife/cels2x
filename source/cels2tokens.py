...
class CelsTokenTypes:
    ...
    KW_CONSTRUCTOR = CelsTokenType(__idp, "KW_CONSTRUCTOR", r'constructor')
    KW_CONTINUE    = CelsTokenType(__idp, "KW_CONTINUE"   , r'continue')
    KW_CPP_INCLUDE = CelsTokenType(__idp, "KW_CPP_INCLUDE", r'cppinclude')
    KW_DESTRUCTOR  = CelsTokenType(__idp, "KW_DESTRUCTOR" , r'destructor')
    ...
    KW_FOR         = CelsTokenType(__idp, "KW_FOR"        , r'for')
    KW_FRAMES      = CelsTokenType(__idp, "KW_FRAMES"     , r'frames')
    ...
    KW_IN          = CelsTokenType(__idp, "KW_IN"         , r'in')
    ...
    KW_ON_FRAME_START = CelsTokenType(__idp, "KW_ON_FRAME_START" , r'on_frame_start')
    KW_ON_FRAME_END   = CelsTokenType(__idp, "KW_ON_FRAME_END"   , r'on_frame_end')
