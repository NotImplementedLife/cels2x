...
from cels_symbols import DataType, PrimitiveType, Variable, FormalParameter, Function, FunctionOverload, BinaryOperator, OperatorSolver, TaskType, UnaryOperatorType
...
class Cels2AST:
    ...
    def __create_grammar(self):
        ...
        s_dec          = rcf.terminal(CelsTokenTypes.S_DEC.name)
        ...
        s_inc          = rcf.terminal(CelsTokenTypes.S_INC.name)
        ...
        G = Grammar([
            ...
            *binary_operator_rules(E_M, E_RTL, [s_star, s_slash, s_percent], self.reduce_binary_operator),
            ...
            ( E_RTL << s_inc * E_RTL      ).on_build(rc.call(self.reduce_unary_operator, rc.arg(0), rc.arg(1))),
            ( E_RTL << s_dec * E_RTL      ).on_build(rc.call(self.reduce_unary_operator, rc.arg(0), rc.arg(1))),
